...
function Upgrade() {
  ...
  const validationsPersonalInfo = [
    {
      name: "categoryName",
      validation: value => !!listImported.includes(value),
      value: categoryName,
  ...
  const supportModalBody = (
    <div>
      <p style={{ paddingTop: "0px", paddingBottom: "10px" }}>
        Qualquer dúvida acerca do cadastro, basta falar conosco via WhatsApp que vamos te ajudar!
      </p>
    </div>
  )
    ...
    <div style={container}>
      {typeRegister === "Completo" ? (
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
          ...
          <h1
            style={{ fontFamily: "Rubik", textTransform: "uppercase", color: "rgb(45, 156, 219)", textAlign: "center" }}
          >
            UPGRADE FOI REALIZADO
          </h1>
      ...
      {typeRegister === "Simplificado" && step === 0 ? (
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
          ...
          <div style={{ display: "grid", width: "100%", marginTop: "20px", opacity: "1", gap: "10px" }}>
            <Button type="button" cta="Fazer upgrade gratuito" template="regular" click={() => setStep(step + 1)} />
            ...
            <Button
              ...
              click={() =>
                window.open(
                  `https://api.whatsapp.com/send?phone=${supportNumber.supportPhoneNumber.replace(
                    /\+|\s|\(|\)|-/g,
                    "",
                  )}`,
                  "_blank",
      ...
      {typeRegister === "Simplificado" && step === 1 && (
        <>
          <p style={{ textAlign: "center", fontSize: "1.6rem", color: "rgb(34, 34, 34)", marginTop: "-10px" }}>
          ...
          <Form
            ...
            inputs={[
              <FormInput
                ...
                input={<SingleImageUpload setFile={setIdDoc} persistFilename={idDoc.name} indexOfFile={0} />}
              />,
              <FormInput
                name="idAtv"
                label=""
                LabelComponent={<AtvdText />}
                input={<SingleImageUpload setFile={setIdAtv} persistFilename={idAtv.name} indexOfFile={1} />}
              />,
              <FormInput
                name="idRes"
                label=""
                LabelComponent={<HomeText />}
                input={<SingleImageUpload setFile={setIdRes} persistFilename={idRes.name} indexOfFile={2} />}
              />,
              <FormInput
                name="idCnpj"
                label=""
                LabelComponent={<CnpjText />}
                input={<SingleImageUpload setFile={setIdCnpj} persistFilename={idCnpj.name} indexOfFile={3} />}
              />,
            ]}
          />
          <div style={{ paddingTop: "15px" }}>
