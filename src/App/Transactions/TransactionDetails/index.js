...
const TransactionDetails = ({
  ...
  const showTransaction = role === "" ? true : docId === transaction.collaboratorId ? true : false
  ...
  async function getTransaction(
    ...
    if (Object.prototype.hasOwnProperty.call(transaction, "sellerZoopPlan")) {
      if (transaction.sellerZoopPlan === "" || (markupTransaction.percentage === 0 && markupTransaction.amount === 0))
        ...
        block = [
          {
            ...
            body: [
              ...
              },
              {
                title: "Valor líquido",
                content:
                  transaction.status !== "Cancelado" && transaction.status !== "Aguardando Pagamento"
                    ? liquidFormatted
                    : "-",
              },
              {
        ...
        if (Object.prototype.hasOwnProperty.call(transaction, "receivables") && transaction.receivables.length > 0) {
          ...
          sortedTransactions.map(transaction => {
            ...
            if (!transaction.paid_at) {
              ...
              if (backRouteEffect)
                unpaidClicks.push(() =>
                  history.push(`/transacoes/${transactionId}/${transaction.receivableZoopId}`, {
                    backRoute: backRouteEffect,
          ...
          dataTable = [
            ...
            },
            {
              ...
              totals: [
                ...
                `${parcelFormat(round(unpaidAmountWithoutFees, 2))}`,
                "-",
                "",
              ],
            },
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={containerWithPadding}>
      ...
      <Header
        ...
        setIsOpen={
          backRoute ? () => history.push(backRoute, { snapshot: snapshotMemo }) : () => setLocation("/transacoes")
        }
        icon="back"
      />
        ...
        {isApproved && role === "" && (
          <>
            ...
            <span style={{ fontFamily: "Rubik", fontSize: "12px" }}>
              * Valores arredondados para a segunda casa decimal
            </span>
          </>
        )}
        {isCanceled && (
