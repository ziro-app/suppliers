            ...
            if (Object.prototype.hasOwnProperty.call(transaction, 'dateLinkCreated')) {
                ...
                let feesFormatted =
                    transaction.status !== 'Cancelado' && transaction.fees
                        ? ` ${(transaction.isNewPlan ? transaction.splitTransaction : transaction.sellerZoopPlan) && markupTransaction.percentage
                            ? '- '.concat(
                ...
                console.log('markupValueFormatted', markupValueFormatted);
                console.log('insuranceValueFormatted', insuranceValueFormatted);
                let liquidFormatted =
