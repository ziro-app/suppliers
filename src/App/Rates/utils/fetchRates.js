...
const fetch = async (zoopId, setLoading, setError, setDataRows, brands, setBlockDetails, setMessage) => {
  try {
    setLoading(true)
    db.collection("utilities")
                    ...
                    body: [
                      {
                        ...
                        content: `${docUtilities.data().main.standardValueBackgroundCheck.toLocaleString("pt-br", {
                          style: "currency",
                          currency: "BRL",
                        })}`,
                      },
