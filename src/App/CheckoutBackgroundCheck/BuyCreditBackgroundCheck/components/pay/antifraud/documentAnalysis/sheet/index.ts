...
import { ZoopCard } from '../../../Zoop';
import { FirebaseCardDocument } from '../../../../../utils/firebase/catalog-user-data';
...
type SheetData = [string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string];
