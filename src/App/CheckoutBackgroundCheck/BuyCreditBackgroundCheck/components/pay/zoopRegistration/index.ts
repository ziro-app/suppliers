import { useStoreownerDocument, StoreownerQueryDocumentSnapshot } from '../../../utils/firebase/storeowners';
import { useAnalytics } from 'reactfire';
import { createBuyer } from '../Zoop';

const suspendIfNeeded = (() => {
    let _error: any;
    let suspender: Promise<any>;
    return <T = string>(analytics: ReturnType<typeof useAnalytics>, storeowner: StoreownerQueryDocumentSnapshot, startWithValue?: T) => {
