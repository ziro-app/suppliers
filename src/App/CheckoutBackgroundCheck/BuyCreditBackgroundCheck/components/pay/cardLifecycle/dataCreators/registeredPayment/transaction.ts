import { GetCard, UnregisteredCard } from '../../../Zoop';
...
export const transaction = async (installments: string, payment: any, card: (UnregisteredCard & { card_brand: string }) | GetCard.Response, buyerZoopId?: string) => {
