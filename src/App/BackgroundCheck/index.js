...
const BackgroundCheck = () => {
  ...
  const { docId, role, ownerId, backgroundCheckRequests, backgroundCheckRequestsPaid, fantasia, bgPrice } = useContext(
    userContext,
  )
                ...
                >
                  ...
                  >
                    {freeMsg === true ? (
                      <>
                        <label style={{ textAlign: "center" }}>
                          <span style={{ color: alertColor, fontWeight: "bold" }}>Atenção!</span> Seus créditos estão
                          acabando. Clique no botão abaixo para adquirir mais.
                        </label>
                        <div
                        ...
                        >
                          ...
                          <label
                            style={{ cursor: "pointer", color: "#fafafa", fontSize: "1.3rem", fontFamily: fontTitle }}
                          >
                            Adquirir créditos
                          </label>
                        </div>
                    ...
                    {zeroMsg === true ? (
                      <>
                        <label style={{ textAlign: "center" }}>
                          <span style={{ color: alertColor, fontWeight: "bold" }}>Atenção! </span>
                          {`Não fique sem créditos. Apenas ${bgCheckPrice.toLocaleString("pt-br", {
                            style: "currency",
                            currency: "BRL",
                          })} por consulta.`}
                        </label>
            ...
            <FormInput
              ...
              LabelComponent={
                <div style={{ paddingLeft: "5px", display: "flex", alignItems: "center", marginBottom: "5px" }}>
                  ...
                  <TooltipHelp illustration="cardAnalysis" title={creditsModalTitle} body={creditsModalBody} />
                </div>
              }
              input={
                <InputText
