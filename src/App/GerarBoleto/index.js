...
const GerarBoleto = ({ boletbankId, boletId }) => {
    ...
    const state = { seller:'ZIRO', sellerId:'6e4b9db52193481ca2a345dfc3577c8e', razao, charge, maxInstallments, docId,url,urlLoad,email,setCharge, setMaxInstallments, setIsError, setIsLoading, setUrl,setUrlLoad, setfisrtTicket, setTicket  }
