...
function AboutCredits() {
  const { backgroundCheckRequests, backgroundCheckRequestsPaid } = useContext(userContext)
  ...
  useEffect(() => {
    backgroundCheckRequests + backgroundCheckRequestsPaid === ""
      ? setCreditsValue("0")
      : backgroundCheckRequests + backgroundCheckRequestsPaid === "0"
        ? setCreditsValue("0")
        : backgroundCheckRequests + backgroundCheckRequestsPaid === undefined
          ? setCreditsValue("0")
          : backgroundCheckRequests + backgroundCheckRequestsPaid === null
            ? setCreditsValue("0")
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
        ...
        <div style={advantagesContainer}>
          ...
          <div style={advantagesDiv}>
            ...
            <label style={advantagesLabel}>{`Cada crédito custa ${bgCheckPrice.toLocaleString("pt-br", {
              style: "currency",
              currency: "BRL",
            })}`}</label>
          </div>
