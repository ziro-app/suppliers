    ...
    const asyncClick = async () => {
        try {
            ...
            const promise = new Promise(async resolve => {
                try {
                    const url = `https://ziro-pay.netlify.app/.netlify/functions/receiving-policy-update?seller_id=${zoopId}`
                    const config = {
                        headers: {
            ...
            {typeRegister === "Completo" ? (
              ...
              <label style={dot}>&nbsp;.</label>
                    ...
                    <Form
                        ...
                        inputs={[
                            <FormInput
                                name="newHolderName"
                                label="Titular"
                                input={<InputText value={holderName} onChange={() => null} readOnly />}
                            />,
                            <FormInput
                                name="bankNumber"
                                label="Banco"
                ...
                >
                    ...
                    <label style={{ fontFamily: fontBody, textAlign: "center" }}>
                        Você não possui dados bancários pois não está habilitado a transacionar. Habilite agora!
          </label>
                    <Button
                        type="link"
                        cta="Fazer upgrade"
