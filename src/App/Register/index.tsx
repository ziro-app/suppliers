...
import {
  ...
  supportModalTitle,
  supportModalBody,
  supportModalTitleRegister,
  supportModalBodyRegister,
} from "./modals"
...
const Register = () => {
  ...
  const validations = [
    ...
    },
    {
      ...
      validation: value =>
        step === 2
          ? /(^\d{3}\.\d{3}\.\d{3}\-\d{2}$)/.test(value) && (process.env.HOMOLOG ? true : validateDocuments(value))
          : true,
      value: cpf,
    ...
    },
    {
      name: "fone",
      validation: value =>
        step === 1 && value.length <= 14 && value !== ""
          ? /(^\(\d{2}\) \d{4}\-\d{4}$)/.test(value)
          : step === 1 && value.length === 15
    ...
    },
    {
      name: "whatsApp",
      validation: value =>
        step === 1 && typeOfRegistration === "Completo" && value === ""
          ? true
          : /(^\(\d{2}\) \d{5}\-\d{4}$)/.test(value),
      value: whatsApp,
    ...
    },
    {
      name: "email",
      validation: value =>
        (typeOfRegistration === "Simplificado" && step === 1) || step === 2 ? /^\S+@\S+\.\S+$/g.test(value) : true,
      value: email,
    ...
    },
    {
      name: "pass",
      validation: value =>
        (typeOfRegistration === "Simplificado" && step === 1) || step === 2 ? !/^.{0,5}$/g.test(value) : true, // tests for min length of 6 char
      value: pass,
    ...
    },
    {
      name: "confirmPass",
      validation: value =>
        (typeOfRegistration === "Simplificado" && step === 1) || step === 2 ? value === pass : true,
      value: confirmPass,
    ...
    <div style={containerWithPadding}>
      ...
      {step === 0 ? (
        <div style={{ display: "flex", flexDirection: "column", textAlign: "center" }}>
          ...
          >
            Crie sua conta na Ziro
          </h1>

          <label style={{ color: "rgb(34, 34, 34)", marginTop: "10px" }}>
            Comece agora a fazer consultas no SERASA e evite fraudes e inadimplência. São 10 consultas gratuitas para
            começar!
          </label>
          ...
          <Form
            ...
            inputs={[
              ...
              <FormInput
                ...
                input={<InputPhone value={fone} setValue={setFone} />}
              />,
              <FormInput
                name="category"
                label="Categoria"
          ...
          <Form
            ...
            inputs={[
              <FormInput
                name="idDoc"
                label=""
                LabelComponent={<DocText />}
                input={<SingleImageUpload setFile={setFileDoc} persistFilename={fileDoc.name} indexOfFile={0} />}
              />,
              <FormInput
                name="idAtv"
                label=""
                LabelComponent={<AtvdText />}
                input={<SingleImageUpload setFile={setFileAtv} persistFilename={fileAtv.name} indexOfFile={1} />}
              />,
              <FormInput
                name="idRes"
                label=""
                LabelComponent={<HomeText />}
                input={<SingleImageUpload setFile={setFileRes} persistFilename={fileRes.name} indexOfFile={2} />}
              />,
              <FormInput
                name="idCnpj"
                label=""
                LabelComponent={<CnpjText />}
                input={<SingleImageUpload setFile={setFileCnpj} persistFilename={fileCnpj.name} indexOfFile={3} />}
              />,
            ]}
          />
          <div style={{ paddingTop: "15px" }}>
          ...
          <Form
            ...
            inputs={[
              ...
              <FormInput
                name="holderName"
                label=""
                LabelComponent={<HolderText />}
                input={<InputText value={reason} onChange={() => {}} disabled={true} />}
              />,
              <FormInput
                name="cnpjValid"
                label="CNPJ"
                input={<InputText value={cnpj} onChange={() => {}} disabled={true} />}
              />,
            ]}
          />
          <div style={{ paddingTop: "15px" }}>
