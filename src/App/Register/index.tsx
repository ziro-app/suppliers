        ...
        <div style={containerWithPadding}>
            ...
            {step === 0 ? (
                <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'center' }}>
                    ...
                    <label style={{ color: 'rgb(34, 34, 34)', marginTop: '10px' }}>Comece agora a fazer consultas gratuitas no SERASA e evite fraudes e inadimplência. São 10 consultas gratuitas por mês!</label>
