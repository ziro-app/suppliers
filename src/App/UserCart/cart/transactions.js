import { fs, db } from "@bit/ziro.firebase.init"
...
export const cartItemProductSubtracter = buyerStoreownerId => (
  productSnapshot,
  cartItemSnapshot,
) => async transaction => {
...
export const cartItemProductAdder = buyerStoreownerId => (productRef, cartItemRef) => async transaction => {
  const productData = {
