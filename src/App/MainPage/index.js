...
function MainPage() {
  ...
  const getPlan = async () => {
    try {
      const result = role === "" ? await getActivePlan(uid) : await getActivePlan(ownerId)
      return setActivePlan(
        result === "standard"
          ? "Fluxo"
          : result === "financed30" && window.innerWidth < 400
            ? "Antecip. D+30"
            : result === "financed30" && window.innerWidth > 400
              ? "Antecipado D+30"
              : result === "financed14" && window.innerWidth < 400
                ? "Antecip. D+14"
                : result === "financed14" && window.innerWidth > 400
                  ? "Antecipado D+14"
                  : setIsErrorPlan(true),
  ...
  const runErrorBalance = () => {
    typeRegister === "Completo" && (
      <Error
        ...
        backRouteFunction={() =>
          window.open(
            `https://api.whatsapp.com/send?phone=${supportNumber.supportPhoneNumber.replace(/\+|\s|\(|\)|-/g, "")}`,
            "_blank",
          )
        }
      />
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <h1 style={valorH1}>
                {payoutAutomatic === "" ? (
                  ...
                  "Manual"
                ) : payoutAutomatic !== true && payoutAutomatic !== false ? (
                  "Não encontrado"
                ) : null}
              </h1>
            </div>
              ...
              <div style={card}>
                ...
                <h1 style={valorH1}>
                  ...
                  {balance < 0 ? (
                    ...
                    currencyFormat(round(balance, 2).toFixed(2).replace(".", "")).replace("R$", "")
                  ) : (
                    "0,00"
                  )}
                </h1>
              ...
              <div style={card}>
                ...
                <h1 style={valorH1}>
                  ...
                  {paidBalance < 0 ? (
                    ...
                    currencyFormat(round(paidBalance, 2).toFixed(2).replace(".", "")).replace("R$", "")
                  ) : (
                    "0,00"
                  )}
                </h1>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              <div style={cardSimplificado}>
                ...
                >
                  ...
                  <label style={{ cursor: "pointer", color: "#fafafa", fontSize: "1.3rem", fontFamily: fontTitle }}>
                    Fazer upgrade
                  </label>
                </div>
              </div>
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                <label style={{ textAlign: "center" }}>
                  Adquira créditos para consultar CPF e CNPJ. Venda para clientes novos com mais segurança.
                </label>
                <div
        ...
        <div>
          <div style={iconDiv}>
            <Icon
              ...
              strokeWidth={2}
              style={iconStyle}
              onClick={() => setLocation("/criar-cobranca")}
            />
          </div>
          ...
          <div>
            <div style={iconDiv}>
              <Icon
                ...
                strokeWidth={2}
                style={iconStyle}
                onClick={() => setLocation("/recebiveis")}
              />
            </div>
          ...
          <div>
            <div style={iconDiv}>
              <Icon
                ...
                strokeWidth={2}
                style={iconStyle}
                onClick={() => setLocation("/dados-bancarios")}
              />
            </div>
