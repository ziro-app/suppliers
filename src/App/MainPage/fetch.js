    ...
    const run = async () => {
        try {
            ...
            while (hasMore) {
                ...
                // let url = `http://localhost:9003/.netlify/functions/sellers-future-releases?seller_id=${zoopId}&expected_on_range[gte]=${parsedToday}&expected_on_range[lte]=${parsedFnDay}&offset=${offset}`;
