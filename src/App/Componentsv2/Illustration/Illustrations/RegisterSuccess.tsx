...
const RegisterSuccess = ({ ...props }: React.SVGAttributes<SVGElement>) => (
  <svg width={150} height={150} viewBox="0 0 788.38181 719" {...props}>
    <defs>
      <linearGradient
    ...
    <polygon points="125 410 0 268 374 0 748 268 621 410 125 410" fill="#2d9cdb" />
    <polygon points="125 410 0 268 374 0 748 268 621 410 125 410" fill="#2d77d8" />
    <rect y="286" width="730" height="319" fill="#2d9cdb" />
    <rect y="286" width="730" height="319" fill="url(#aeee3e51-5d06-43ae-b234-e7a12d326f50)" />
    <polygon points="748 719 0 719 0 268 374 494 748 268 748 719" fill="#2d9cdb" />
    <polygon
    ...
    />
    <polygon points="59.087 115.617 75.131 130.493 2.411 166.646 41.11 117.046 59.087 115.617" fill="#2d9cdb" />
    <polygon points="59.087 115.617 75.131 130.493 2.411 166.646 41.11 117.046 59.087 115.617" opacity="0.2" />
    <polygon points="40.373 99.66 2.411 166.646 59.087 115.617 40.373 99.66" fill="#2d9cdb" />
    <polygon points="75.599 142.01 2.489 166.16 63.604 120.539 75.599 142.01" fill="#2d9cdb" />
    <polygon points="686.959 38.73 670.942 66.499 788.382 85.622 712.742 32.949 686.959 38.73" fill="#2d9cdb" />
    <polygon points="686.959 38.73 670.942 66.499 788.382 85.622 712.742 32.949 686.959 38.73" opacity="0.2" />
    <polygon points="706.247 8.293 788.382 85.622 686.959 38.73 706.247 8.293" fill="#2d9cdb" />
    <polygon points="675.274 82.821 788.062 84.976 682.769 47.576 675.274 82.821" fill="#2d9cdb" />
  </svg>
)
