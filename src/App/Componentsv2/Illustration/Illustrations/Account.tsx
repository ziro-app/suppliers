...
const Account = ({ ...props }: React.SVGAttributes<SVGElement>) => (
  <svg width={150} height={150} viewBox="0 0 785 753.73" {...props}>
    <defs>
      <linearGradient
      ...
      <linearGradient
        ...
        x2="209.37"
        y2="101.61"
        href="#b4c3f788-9d51-49bd-96f9-c54f9fd51398"
      />
      <linearGradient
    ...
    <rect x="65.88" y="134" width="365.14" height="232.26" fill="#2d9cdb" opacity="0.2" />
    ...
    <rect x="36.85" y="156.33" width="134" height="142.93" fill="#2d9cdb" />
    <path
      ...
      fill="#fff"
    />
    <rect x="4.47" y="106.08" width="408.69" height="30.15" fill="#2d9cdb" />
    <rect x="225.56" y="198.2" width="155.21" height="10.05" fill="#e0e0e0" />
    <rect x="225.56" y="240.64" width="155.21" height="10.05" fill="#f5f5f5" />
    <rect x="224.45" y="219.42" width="91.56" height="10.05" fill="#2d9cdb" opacity="0.2" />
    ...
    <rect x="185.36" y="585.12" width="53.6" height="18.98" fill="#2d9cdb" />
    ...
    <rect x="418.74" y="654.35" width="305.96" height="54.72" fill="#2d9cdb" />
    ...
    <rect x="537.11" y="101.61" width="187.6" height="134" fill="#2d9cdb" />
