...
const NoData = ({ ...props }: React.SVGAttributes<SVGElement>) => (
  <svg width={150} height={150} viewBox="0 0 820.16 780.81" {...props}>
    <defs>
      <linearGradient
    ...
    />
    <rect x="377.02" y="104.56" width="199.84" height="47.27" fill="#2d9cdb" />
    <path
