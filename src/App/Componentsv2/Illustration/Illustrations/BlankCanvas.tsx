...
const BlankCanvas = ({ ...props }: React.SVGAttributes<SVGElement>) => (
  <svg width={150} height={150} viewBox="0 0 998.95 833.99" {...props}>
    <defs>
      <linearGradient
    ...
    <path
      ...
      fill="#2d9cdb"
    />
    <ellipse cx="374.17" cy="814.05" rx="118.88" ry="19.93" fill="#2d9cdb" opacity="0.1" />
    <ellipse cx="608.16" cy="661.06" rx="118.88" ry="19.93" fill="#2d9cdb" opacity="0.1" />
    <polygon
    ...
    <path
      ...
      opacity="0.1"
    />
    <path d="M488.65,554s16.44,0,24.06.45S488.65,554,488.65,554Z" transform="translate(-100.52 -33.01)" opacity="0.1" />
    <path
    ...
    <path
      ...
      opacity="0.1"
    />
    <ellipse cx="90.82" cy="763.14" rx="44.18" ry="8.64" fill="#2d9cdb" opacity="0.1" />
    <ellipse cx="827.28" cy="706.15" rx="32.18" ry="6.29" fill="#2d9cdb" opacity="0.1" />
    <ellipse cx="966.77" cy="731.64" rx="32.18" ry="6.29" fill="#2d9cdb" opacity="0.1" />
    <ellipse cx="750.78" cy="784.14" rx="32.18" ry="6.29" fill="#2d9cdb" opacity="0.1" />
    <path
    ...
    <path
      ...
      fill="#ffd037"
    />
    <ellipse cx="113.46" cy="643.07" rx="75.65" ry="11.61" fill="#2d9cdb" opacity="0.1" />
    <path
    ...
    <circle cx="179.99" cy="124.52" r="31.5" fill="#2d9cdb" opacity="0.1" />
    <circle cx="113.99" cy="49.52" r="19.5" fill="#2d9cdb" opacity="0.1" />
    <circle cx="12" cy="93.02" r="12" fill="#2d9cdb" opacity="0.1" />
  </svg>
)
